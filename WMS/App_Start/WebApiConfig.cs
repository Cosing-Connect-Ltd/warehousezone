...
namespace WMS
{
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            config.Routes.MapHttpRoute("ProductLocationStocksSync", "api/sync/product-location--stocks/{reqDate}/{serialNo}", new { controller = "ApiProductLocationStocksSync", action = "GetProductLocationStocks", reqDate = string.Empty, serialNo = string.Empty });
