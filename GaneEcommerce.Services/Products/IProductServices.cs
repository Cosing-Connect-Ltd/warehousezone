...
namespace Ganedata.Core.Services
{
    public interface IProductServices
    {
        ...
        IEnumerable<ProductMaster> GetProductByCategory(int SitId, int tenantId, int NumberofProducts, bool TopProduct = false, bool BestSellerProduct = false, bool SpecialProduct = false, bool OnSaleProduct = false);
