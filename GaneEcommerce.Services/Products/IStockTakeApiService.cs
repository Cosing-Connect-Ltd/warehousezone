...
namespace Ganedata.Core.Services
{
    public interface IStockTakeApiService
    {
        ...
        StockTakeDetail CreateStockTakeDetail(StockTakeDetail detail);
        StockTakeDetailsPallets CreateStockTakeDetailsPallets(StockTakeDetailsPallets detailPallet);
    }
}